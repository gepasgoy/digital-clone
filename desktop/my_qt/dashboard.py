...
# Виджет 1 — Эффективность лечения
...
fig = px.line(
    treatment_df,
    x="Дата",
    y=["Среднее давление", "Глюкоза", "CRP"],
    title="Динамика клинических показателей"
)

st.plotly_chart(fig, use_container_width=True)

# Виджет 2 — Статистика заболеваний
...
fig = px.bar(
    work_df,
    x="День",
    y=["Первичных", "Повторных"],
    title="Структура приемов по дням",
    barmode="stack"
)
