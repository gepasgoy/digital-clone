...
st.write("### Добавить измерение пульса")

value = st.number_input("Значение пульса (уд/мин)", 
                       min_value=30, max_value=300, value=70)

patient_id = st.number_input("ID пациента (оставьте пустым для себя)", 
